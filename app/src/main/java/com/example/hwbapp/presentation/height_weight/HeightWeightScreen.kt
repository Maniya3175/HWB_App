package com.example.hwbapp.presentation
...
import com.example.hwbapp.MainActivity3
import com.example.hwbapp.data.ConnectionState
import com.example.hwbapp.presentation.ble_start.Screen
import com.example.hwbapp.presentation.height_weight.HeightWeightViewModel
        ...
        Column(
            ...
            if(bleConnectionState == ConnectionState.CurrentlyInitializing){
                ...
                Column(
                    ...
                    Button(onClick = {
                        viewModel.disconnect()
                        navController.navigate(Screen.BicepScreen.route){
                            popUpTo(Screen.HeightWeightScreen.route){
                                inclusive = false
                            }
                        }
                    }) {
                        Text(text = "Next Bicep Screen")
                    }
                }
